        ...
        popConfirm: function (options) {
            ...
            return this.each(function () {
                ...
                self.popover({
                    ...
                    content: options.content + '<p class="button-group" style="margin: 2px; text-align: center;"> <button type="button" class="btn btn-xs btn-danger confirm-dialog-btn-confirm">' + options.yesBtn + '</button> <button type="button" class="btn btn-xs confirm-dialog-btn-abord">' + options.noBtn + '</button> </p>'
                }).click(function (e) {
                    if (last && last !== self) {
